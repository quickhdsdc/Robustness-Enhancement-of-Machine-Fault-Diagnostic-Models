...
#                                      data_format=K.image_data_format())
    ...
    x = Conv2D(filters=out_channels_in_stage[0], kernel_size=(3, 3), padding='same', use_bias=False, strides=(2, 2), name='conv1')(img_input)
    ...
    if bottleneck_ratio < 2:
        ...
        k = 2048
    x = Conv2D(k, kernel_size=1, padding='same', strides=1, name='1x1conv5_out')(x)
    x = BatchNormalization()(x)
    x = Activation('relu')(x)
    if pooling == 'avg':

...
#=============================================================================#
###################### test the CNN model: speed range ########################
#=============================================================================#
...
#x_train=ExtraFeatures(x_train,500)
#DataPath = os.path.abspath(os.path.join(os.getcwd(), "./ESZUEG_500/train_v55v95"))
...
#x_train=pd.concat([x_train[0:n_realsample],x_train[n_realsample:n_realsample+1000],x_train[n_realsample+2000:n_realsample+3000],x_train[n_realsample+4000:n_realsample+5000],x_train[n_realsample+6000:n_realsample+7000],x_train[n_realsample+8000:n_realsample+9000]])        
...
for n in range(0,10):
    ...
    try:
        ...
        pass   
#    model=CNN_arch((1000,1))
#    model=CNN_arch((131,8))
#    model=CNN_arch((33,33,1))                                                   # build model
...
#
#        if len(x_test[0,:,0])==1000:
#            x_test=wpt(x_test,level)                                               # wavelet paket transformation 
#        if len(x_train[0,:,0])==1000:
#            x_train=wpt(x_train,level)          
#        if len(x_val[0,:,0])==1000:
#            x_val=wpt(x_val,level)                  
#
#        if len(x_test[0,:,0])==1000:

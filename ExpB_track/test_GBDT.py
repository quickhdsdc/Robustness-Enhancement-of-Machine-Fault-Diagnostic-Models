...
#=============================================================================#
###################### read features as training data #########################
#=============================================================================#
#fs=500
...
for n in range(0,10):
    ...
    acc,_,_,_,_=test_GBDT(model,x_test_AbBad,y_test_AbBad)
    metrics_test_AbBad[n,0]=acc
           
    acc,_,_,_,_=test_GBDT(model,x_test_osc,y_test_osc)
    metrics_test_osc[n,0]=acc
        
    acc,_,_,_,_=test_GBDT(model,x_test_peak,y_test_peak)
    metrics_test_peak[n,0]=acc
            
    acc,_,_,_,_=test_GBDT(model,x_test_per,y_test_per)
